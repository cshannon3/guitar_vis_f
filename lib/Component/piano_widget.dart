...
class _pianoWidgetState extends State<pianoWidget> {
  ...
  @override
  void initState() {
    (widget.rootnote != -1) ? noteshighlighted = [(widget.rootnote+scales[widget.currentscale][widget.tonalhighlight])%12,
  ...
  Widget _buildKey2(int keyname) {
    return Padding(
      ...
      child: new Container(
        ...
        child: (widget.notesShown[keyname%12]) ? Container(
          color: noteshighlighted.isEmpty ? false : noteshighlighted.contains(keyname%12) ?
